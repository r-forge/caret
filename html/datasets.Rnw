...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
	...
	<div id="content">
	  ...
	  <p>
	    Using <code>data(cox2)</code> exposes three R objects: <code>cox2Descr</code> is a data frame with the descriptor data, <code>cox2IC50</code> is a numeric vector of IC50 assay values and <code>cox2Class</code> is a factor vector with the activity results.
	  </p>
...
Using <code>data(tecator)</code> loads a 215 x 100 matrix of absorbance spectra and a 215 x 3 matrix of outcomes.
</p>
...
dim(fattyAcids)
@
<<oil_print,results=html,echo=FALSE>>=
printOutput(dim(fattyAcids))
@ 
<<oil2,results=hide>>=
table(oilType)
@
<<oil2_print,results=html,echo=FALSE>>=
printOutput(table(oilType))
@ 
...
@
<<GC_print,results=html,echo=FALSE>>=
printOutput(str(GermanCredit[, 1:10]))
@ 
...
@
<<CS_print,results=html,echo=FALSE>>=
printOutput(str(segmentationData[,1:10]))
@ 
