...
\begin{itemize}\raggedright
  ...
  \item Other packages: caret~4.99, cluster~1.14.0, codetools~0.2-8,
    doMC~1.2.2, foreach~1.3.2, iterators~1.0.5, lattice~0.19-31,
    multicore~0.1-5, plyr~1.5.2, randomForest~4.6-2, reshape~0.8.4
  \item Loaded via a namespace (and not attached): grid~2.13.1,
    tools~2.13.1
\end{itemize}
